...
> **🎯 Recent Update**: Linting and formatting checks have been moved from CI to pre-commit hooks only. This makes CI faster and less error-prone while ensuring code quality is maintained during development.
