...
const mockSearchData = [
  {
    ...
    content: 'Learn about React 18 concurrent features and how they improve performance',
...
describe('SearchBar', () => {
  ...
  it('renders search input with correct placeholder', () => {
    ...
    expect(screen.getByPlaceholderText('Search articles, authors, tags...')).toBeInTheDocument();
  ...
  it('displays search results correctly', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('React 18 Concurrent Features')).toBeInTheDocument();
      expect(screen.getByText('A comprehensive guide to React 18 concurrent features')).toBeInTheDocument();
  ...
  it('filters results by title', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.queryByText('React 18 Concurrent Features')).not.toBeInTheDocument();
    }, { timeout: 2000 });
  });
  ...
  it('handles empty search data gracefully', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('No results found for "react"')).toBeInTheDocument();
    }, { timeout: 2000 });
  });
